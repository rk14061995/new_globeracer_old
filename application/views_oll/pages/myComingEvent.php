            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header font-weight-bold">
                   <a href="<?=base_url('User/viewEventDescription/').$evt->event_id?>"><?='Event: '.ucwords($evt->event_name)?></a>
                  <hr>
                </div>
                <div class="card-body">
                 <!--  <img src="<?=base_url('assets/img/eventsImage/')?>" width="100%" style="max-height: 200px">
                  <hr> -->
                  <p>
                    <label>Distance:</label> <?=($evt->event_distance/1000).'Km '?>(<?=$evt->event_distance?>)m 
                  </p>
