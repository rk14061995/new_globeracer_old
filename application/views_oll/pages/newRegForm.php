	    ...
	    <?php 
	        if(count($userSessionData)>0){
	           ...
	           $DDat=$userSessionData[0];
	            ?>
	                <script>
	                     $('#first_name').val('<?=$DDat->firstname?>');
                          $('#mid_name').val('<?=$DDat->middle_name?>');
                          $('#last_name').val('<?=$DDat->lastname?>');
                          $('#participant_email').val('<?=$DDat->user_email?>');
                          $('#phone_no').val('<?=$DDat->contact_no?>');
                          $('#user_nameee').val('<?=$DDat->user_email?>');
                          $('#clikLOg').hide();
                          $('#pswd_field').hide();
                          $('#myModal').modal('hide');
	                </script>
	        ...
	        <div class="col-md-6 offset-md-3">
	            <div class="card">
	                <div class="card-header">
	                    <a href="javascript:void(0)" id="loginModal" >Click here to Log In</a>
	                </div>
	            </div>
                    ...
                    <form id="regForm" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" class="form-control"  name="mid_name" id="mid_name" placeholder="Middle Name" value="" >
                            </div>
                            <div class="col-md-4 form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="email" class="form-control" name="participant_email" id="participant_email" placeholder="Participant Email Id." value="" required>
                            </div>
                            <div class="col-md-6 form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control " name="phone_no" id="phone_no" placeholder="123456789">
                                    </div>
                                </div>
                ...
                success: function(response) {
                    ...
                    if(response.code==1){
                        if(response.type=="Admin"){
                            swal("Events", "Something Went Wrong.", "error");
                            // window.location.href="<?=base_url('Events')?>";
                        }else{
                            swal("User", "Something Went Wrong.", "error");
