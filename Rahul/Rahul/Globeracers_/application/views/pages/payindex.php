                        ...
                        <div class="main">
                        	...
                        	<form action="#" id="payment_form">
                               ...
                               <label>Transaction/Order ID:</label>
                                ...
                                <label>Amount:</label>
                                <input type="text" id="amount" class="form-control" name="amount" placeholder="Amount" value="<?=$eventData[0]->amount_to_pay?>" readonly/>    
                                <input type="hidden" id="pinfo" class="form-control" name="pinfo" placeholder="Product Info" value="<?=$eventData[0]->event_id?>" readonly/>
                                <label>First Name:</label>
                                <input type="text" id="fname" class="form-control" name="fname" placeholder="First Name" value="" />
                                <label>Email ID:</label>
                                <input type="text" id="email" class="form-control" name="email" readonly placeholder="Email ID" value="<?=$userSessionData[0]->user_email?>" />
