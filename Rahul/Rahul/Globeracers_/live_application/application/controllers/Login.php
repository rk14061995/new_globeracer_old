<?php
  ...
  //       	/* Array Parameter Data */
	 ...
	 //        curl_close($ch);ReplaceWithAccessToken"
		...
		public function activityFilter($filter="",$date=""){
        ...
        //                 // $condition=array("start_date >="=>$date,"athlete_id"=>$user_id,"type"=>$filter);
        //                 $query="select * from event_details where athlete_id='$user->uId' and start_date='$date' and type like '%".$filter."%' ";
        //                 $athData=$this->db->query($query)->result();
        //                 print_r($athData);
        //             }else{
        //                 $this->session->set_flashdata('msg',' Auth Failed. ');
        //             }
    		  //  }else{
    		  //      echo ' Here Only ';
    		  //    //  $date=date('Y-m-d');
        ...
        //                 $query="select * from event_details where athlete_id='$user->uId' and start_date >='2020-11-14' and type like '%".$filter."%'";
        //                 $athData=$this->db->query($query)->result();
        //                 // print_r($athData);
        //                 // echo '<td>'..'</td>';
        //             }else{
    ...
    //                 $user_id=$data['userSessionData'][0]->user_id;
    //                 // $condition=array("start_date >="=>$date,"athlete_id"=>$user_id,"type"=>$filter);
    //                 $query="select * from event_details where start_date='$date' and type like '%".$filter."%'";
    //                 $athData=$this->db->query($query)->result();
    //                 print_r($athData);
    //             }else{
    //                 $this->session->set_flashdata('msg',' Auth Failed. ');
    ...
    //                 $data['userSessionData']=unserialize($this->session->userdata('userData'));
    //                 $user_id=$data['userSessionData'][0]->user_id;
    //                 $query="select * from event_details where start_date >='2020-11-14' and type like '%".$filter."%'";
    //                 $athData=$this->db->query($query)->result();
    //                 print_r($athData);
    //             }else{
    //                 $this->session->set_flashdata('msg',' Auth Failed. ');
