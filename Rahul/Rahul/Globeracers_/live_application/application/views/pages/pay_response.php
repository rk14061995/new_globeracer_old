...
if (isset($postdata ['key'])) {
	...
	$userData=$this->db->where('user_email',$email)->get('user_details')->row();
    // print_r($userData);
	$userid=$userData->id_table;
	   ...
	   //print_r($condition);
	    if($this->db->where($condition)->update('race_registeration',$updatedata)){
            ...
            $this->email->initialize($config);
                $email=$useremail;
                // $email="rohansingh14061995@gmail.com";
                ...
                if($st){
                    ...
                    $this->email->from('info@globeracers.com');
                    $email_="data@globeracers.com";
                    $this->email->to($email_);
                    $this->email->subject("Earth Matter: New Registration");
                    $message2 = "Dear Admin,
                                $username Registered Successfully for the Event. 
                                The Event Details Are Given Below:-
                                Event Name:-$event_name
                                Event Category:-$event_category
                                Event Venue :- $event_venue
                ...
                //Mail To Owner
                // data@globeracers.com
                //  $email="data@globeracers.com";
                // $this->email->to($email);
                // $this->email->subject($subject);
                // $message2 = "Dear Admin,
                //             $username Registered Successfully for the Event. 
        ...
        //          $ci->email->send();
	        ...
	        echo $msg = "Transaction Successful and Failed To Update";
	    }
